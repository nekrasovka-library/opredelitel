      ...
      {!isClosed && (
        <HowDescription>
          <div>
            ...
            Для&nbsp;каждого узора мы&nbsp;привели основную иллюстрацию, главный
            термин и&nbsp;краткую характеристику. По&nbsp;возможности приведены
            дополнительные иллюстрации. Для&nbsp;большинства узоров приведены
            также дополнительные термины.
            <br />
            <br />
            <span>Основная иллюстрация</span> представляет узор в&nbsp;его
            стандартном виде, а&nbsp;дополнительные иллюстрации представляют
            различные варианты исполнения узора.
            <br />
            <br />
            <span>Главный термин</span>&nbsp;— название узора, используемое
            в&nbsp;каталоге
            библиотеки&nbsp;имени&nbsp;Н.&nbsp;А.&nbsp;Некрасова.
            <br />
            <br />
            <span>Дополнительные термины</span>&nbsp;— названия узора,
            используемые в&nbsp;книговедческих публикациях
            и&nbsp;интернет-ресурсах, а&nbsp;также среди художников,
            переплётчиков, реставраторов и&nbsp;антикваров, в&nbsp;том числе
            на&nbsp;английском, немецком&nbsp;и&nbsp;французском&nbsp;языках.
            <br />
            <br />
            <span>Краткая характеристика</span> узора содержит указания
