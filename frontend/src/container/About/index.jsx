        ...
        {paperType === 2 && (
          <>
            ...
            <div>
              ...
              и&nbsp;инструментами выполняется дальнейший декор. Узоры создаются
              непосредственно на&nbsp;поверхности бумаги путём продавливания
              и&nbsp;перемещения этой окрашенной пасты. Клейстерная бумага
              бывает однотонной или многоцветной. Характерной чертой клейстерной
              бумаги является её&nbsp;всегда отчётливо узнаваемая текстура.
              Следует отличать клейстерную бумагу от&nbsp;бумаги с&nbsp;узором,
              напечатанным клейстерной краской. В&nbsp;последнем случае клейстер
              наносится на&nbsp;печатную форму, а&nbsp;не&nbsp;на лист.
              <br />
              <br />
              В&nbsp;XVIII&nbsp;веке в&nbsp;Европе была популярна гернгутская
              клейстерная бумага (Herrnhuter Kleisterpapier).
              Её&nbsp;изготавливала религиозная община в&nbsp;саксонском городе
              Гернгут (Herrnhut) в&nbsp;1764—1824&nbsp;годах. Характерный стиль
              мастерской&nbsp;— использование деревянных печатных форм, резных
              ролей, гребней в&nbsp;сочетании с&nbsp;ручной рисованной отделкой.
              Метод крашения бумаги был заимствован у&nbsp;мануфактур
              по&nbsp;производству печатного текстиля. Гернгутская бумага была
              чаще однотонной и&nbsp;реже многоцветной, изготавливалась с&nbsp;
              ...
              профессиональным это&nbsp;ремесло, привлекли к&nbsp;нему внимание
              общественности. Гернгутская клейстерная бумага стала так
              популярна, что&nbsp;к&nbsp;1800&nbsp;году стала почти синонимом
              клейстерной бумаги. Существуют более поздние подражания
              гернгутскому стилю.
            </div>
          </>
        )}
